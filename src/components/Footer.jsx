...
const Footer = () => {
  ...
  return (
		...
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-12 h-12 rounded-full dark:dark:bg-violet-400">
					<img src="/logo4.svg" alt="" srcset="" />
					
				</div>
				<span className="self-center text-2xl font-semibold">Mevin Boxing Club</span>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center dark:dark:text-gray-400">&copy; {currentYear}  Mevin All rights reserved.</div>
</footer>
  )
}
